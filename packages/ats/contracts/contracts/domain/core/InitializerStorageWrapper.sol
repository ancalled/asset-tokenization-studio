...
library InitializerStorageWrapper {
    ...
    {
        configId_ = ResolverProxyStorageWrapper.getResolverProxyConfigurationId();   // configId_  = INITIALIZE_MOCK_CONFIG_ID
        versionId_ = ResolverProxyStorageWrapper.getResolverProxyVersion();          // versionId_ = 1
